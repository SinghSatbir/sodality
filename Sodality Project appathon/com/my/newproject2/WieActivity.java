...
public class WieActivity extends Activity {
    private Intent f23a = new Intent();
    ...
    class C01021 implements OnClickListener {
        ...
        public void onClick(View view) {
            WieActivity.this.f23a.setClass(WieActivity.this.getApplicationContext(), WieieeeActivity.class);
            WieActivity.this.startActivity(WieActivity.this.f23a);
        }
    }

    protected void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView(C0083R.layout.wie);
        initialize();
        initializeLogic();
    }
    ...
    private void initialize() {
        ...
        this.button2.setOnClickListener(new C01021());
    }
